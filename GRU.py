...
class TextGRU(object):
    ...
    def __init__(self):
        description = R'''GRU network for text prediction, trained on given dataset.'''
    ...
    def build(self):
        ...
        l = GRU(512, dropout=0.5, recurrent_dropout=0.5, return_sequences=True)(inputs)
        l = GRU(512, dropout=0.5, recurrent_dropout=0.5)(l)
